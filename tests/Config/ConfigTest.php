...
class ConfigTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetStringValue()
    {
        ...
        $this->assertEquals(
            'value',
            config_get($config, 'one.two.three')
        );
    }
    ...
    public function testGetValueByIndex()
    {
        ...
        $this->assertEquals(
            'world',
            config_get($config, 'one.two.three.1')
        );
    }
    ...
    public function testGetDefault()
    {
        ...
        $this->assertEquals(
            'value',
            config_get($config, 'one.two.three.four', 'value')
        );
    }
    ...
    public function testSetString()
    {
        ...
        $returnVal = config_set($config, 'one.twob', 'hello world');
    ...
    public function testSetArray()
    {
        ...
        $returnVal = config_set($config, 'one.twob', array('threeb' => 'foo bar'));
    ...
    public function testSetReplaceString()
    {
        ...
        $returnVal = config_set($config, 'one.two.three', 'hello world');
    ...
    public function testUnsetValue()
    {
        ...
        $returnVal = config_unset($config, 'one.two.three');
    ...
    public function testUnsetSection()
    {
        ...
        $returnVal = config_unset($config, 'one.two');
    ...
    public function testFlatten()
    {
        ...
        $this->assertEquals($expected, config_flatten($config));
    }
    ...
    public function testExpand()
    {
        ...
        $this->assertEquals($expected, config_expand($flatConfig));
    }
}
